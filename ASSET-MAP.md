...
|---|---|---|
| Coding-room desk scene — dual monitors, white tiger, neon city skyline through the window, "A better version of myself everyday." | `assets/hero/hero.jpg` / `.webp` | Top of `README.md` — the cinematic hero banner |
| Same coding-room image, resized smaller | `assets/hero/workspace.jpg` / `.webp` | Reserved for reuse if you split the hero into a smaller "About" panel later |
